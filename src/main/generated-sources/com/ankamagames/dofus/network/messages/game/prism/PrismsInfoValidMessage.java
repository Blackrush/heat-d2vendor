...
public class PrismsInfoValidMessage extends NetworkMessage {
    ...
    public PrismsInfoValidMessage() { }
        ...
        public PrismsInfoValidMessage(com.ankamagames.dofus.network.types.game.prism.PrismFightersInformation[] fights) {
        ...
        public PrismsInfoValidMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.prism.PrismFightersInformation> fights) {
            

            
                
                this.fights = fights.toArray(com.ankamagames.dofus.network.types.game.prism.PrismFightersInformation[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int fights_length = reader.read_ui16();
                    ...
                    this.fights = new com.ankamagames.dofus.network.types.game.prism.PrismFightersInformation[fights_length];
