...
public class ExchangeMountsPaddockAddMessage extends NetworkMessage {
    ...
    public ExchangeMountsPaddockAddMessage() { }
        ...
        public ExchangeMountsPaddockAddMessage(com.ankamagames.dofus.network.types.game.mount.MountClientData[] mountDescription) {
        ...
        public ExchangeMountsPaddockAddMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.mount.MountClientData> mountDescription) {
            

            
                
                this.mountDescription = mountDescription.toArray(com.ankamagames.dofus.network.types.game.mount.MountClientData[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int mountDescription_length = reader.read_ui16();
                    ...
                    this.mountDescription = new com.ankamagames.dofus.network.types.game.mount.MountClientData[mountDescription_length];
