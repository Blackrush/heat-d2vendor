...
public class UpdateMountBoostMessage extends NetworkMessage {
    ...
    public UpdateMountBoostMessage() { }
        ...
        public UpdateMountBoostMessage(int rideId, com.ankamagames.dofus.network.types.game.mount.UpdateMountBoost[] boostToUpdateList) {
        ...
        public UpdateMountBoostMessage(int rideId, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.mount.UpdateMountBoost> boostToUpdateList) {
                ...
                this.boostToUpdateList = boostToUpdateList.toArray(com.ankamagames.dofus.network.types.game.mount.UpdateMountBoost[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int boostToUpdateList_length = reader.read_ui16();
                    ...
                    this.boostToUpdateList = new com.ankamagames.dofus.network.types.game.mount.UpdateMountBoost[boostToUpdateList_length];

                    for (int i = 0; i < boostToUpdateList_length; i++) {
                        
                            int boostToUpdateList_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.mount.UpdateMountBoost boostToUpdateList_it = (com.ankamagames.dofus.network.types.game.mount.UpdateMountBoost)
