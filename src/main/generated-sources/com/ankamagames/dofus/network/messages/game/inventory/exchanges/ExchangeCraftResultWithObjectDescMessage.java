...
public class ExchangeCraftResultWithObjectDescMessage extends com.ankamagames.dofus.network.messages.game.inventory.exchanges.ExchangeCraftResultMessage {
    ...
    public ExchangeCraftResultWithObjectDescMessage() { }
        ...
        public ExchangeCraftResultWithObjectDescMessage(byte craftResult, com.ankamagames.dofus.network.types.game.data.items.ObjectItemNotInContainer objectInfo) {
    ...
    public void deserialize(DataReader reader) {
        ...
        super.deserialize(reader);
                    ...
                    this.objectInfo = new com.ankamagames.dofus.network.types.game.data.items.ObjectItemNotInContainer();
