...
public class PartyInvitationDetailsMessage extends com.ankamagames.dofus.network.messages.game.context.roleplay.party.AbstractPartyMessage {
    public static final int PROTOCOL_ID = 6263;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.party.PartyInvitationMemberInformations[] members;
    ...
    public PartyInvitationDetailsMessage() { }
        ...
        public PartyInvitationDetailsMessage(int partyId, byte partyType, java.lang.String partyName, int fromId, java.lang.String fromName, int leaderId, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.roleplay.party.PartyInvitationMemberInformations> members, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.roleplay.party.PartyGuestInformations> guests) {
            ...
            super(partyId);
                ...
                this.members = members.toArray(com.ankamagames.dofus.network.types.game.context.roleplay.party.PartyInvitationMemberInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
        ...
        super.deserialize(reader);
                ...
                int members_length = reader.read_ui16();
                    ...
                    this.members = new com.ankamagames.dofus.network.types.game.context.roleplay.party.PartyInvitationMemberInformations[members_length];

                    for (int i = 0; i < members_length; i++) {
                        
                            com.ankamagames.dofus.network.types.game.context.roleplay.party.PartyInvitationMemberInformations members_it =
                                    new com.ankamagames.dofus.network.types.game.context.roleplay.party.PartyInvitationMemberInformations();
