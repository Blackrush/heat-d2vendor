...
public class SpellListMessage extends NetworkMessage {
    ...
    public SpellListMessage() { }
        ...
        public SpellListMessage(boolean spellPrevisualization, com.ankamagames.dofus.network.types.game.data.items.SpellItem[] spells) {
        ...
        public SpellListMessage(boolean spellPrevisualization, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.SpellItem> spells) {
                ...
                this.spells = spells.toArray(com.ankamagames.dofus.network.types.game.data.items.SpellItem[]::new);
