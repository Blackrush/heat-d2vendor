...
public class GameFightShowFighterMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 5864;
        ...
        public com.ankamagames.dofus.network.types.game.context.fight.GameFightFighterInformations informations;
    

    public GameFightShowFighterMessage() { }

    
        public GameFightShowFighterMessage(com.ankamagames.dofus.network.types.game.context.fight.GameFightFighterInformations informations) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.informations = (com.ankamagames.dofus.network.types.game.context.fight.GameFightFighterInformations) InternalProtocolTypeManager.get(informations_typeId);
