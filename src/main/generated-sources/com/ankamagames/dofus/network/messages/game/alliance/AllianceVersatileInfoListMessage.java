...
public class AllianceVersatileInfoListMessage extends NetworkMessage {
    ...
    public AllianceVersatileInfoListMessage() { }
        ...
        public AllianceVersatileInfoListMessage(com.ankamagames.dofus.network.types.game.social.AllianceVersatileInformations[] alliances) {
        ...
        public AllianceVersatileInfoListMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.social.AllianceVersatileInformations> alliances) {
            

            
                
                this.alliances = alliances.toArray(com.ankamagames.dofus.network.types.game.social.AllianceVersatileInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int alliances_length = reader.read_ui16();
                    ...
                    this.alliances = new com.ankamagames.dofus.network.types.game.social.AllianceVersatileInformations[alliances_length];
