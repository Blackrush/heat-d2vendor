...
public class GameContextMoveMultipleElementsMessage extends NetworkMessage {
    ...
    public GameContextMoveMultipleElementsMessage() { }
        ...
        public GameContextMoveMultipleElementsMessage(com.ankamagames.dofus.network.types.game.context.EntityMovementInformations[] movements) {
        ...
        public GameContextMoveMultipleElementsMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.EntityMovementInformations> movements) {
            

            
                
                this.movements = movements.toArray(com.ankamagames.dofus.network.types.game.context.EntityMovementInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int movements_length = reader.read_ui16();
                    ...
                    this.movements = new com.ankamagames.dofus.network.types.game.context.EntityMovementInformations[movements_length];
