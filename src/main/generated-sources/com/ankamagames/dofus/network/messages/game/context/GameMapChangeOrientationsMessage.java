...
public class GameMapChangeOrientationsMessage extends NetworkMessage {
    ...
    public GameMapChangeOrientationsMessage() { }
        ...
        public GameMapChangeOrientationsMessage(com.ankamagames.dofus.network.types.game.context.ActorOrientation[] orientations) {
        ...
        public GameMapChangeOrientationsMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.ActorOrientation> orientations) {
            

            
                
                this.orientations = orientations.toArray(com.ankamagames.dofus.network.types.game.context.ActorOrientation[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int orientations_length = reader.read_ui16();
                    ...
                    this.orientations = new com.ankamagames.dofus.network.types.game.context.ActorOrientation[orientations_length];
