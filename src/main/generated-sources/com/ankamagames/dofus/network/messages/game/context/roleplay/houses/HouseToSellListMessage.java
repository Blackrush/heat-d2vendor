...
public class HouseToSellListMessage extends NetworkMessage {
    ...
    public HouseToSellListMessage() { }
        ...
        public HouseToSellListMessage(short pageIndex, short totalPage, com.ankamagames.dofus.network.types.game.house.HouseInformationsForSell[] houseList) {
        ...
        public HouseToSellListMessage(short pageIndex, short totalPage, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.house.HouseInformationsForSell> houseList) {
                ...
                this.houseList = houseList.toArray(com.ankamagames.dofus.network.types.game.house.HouseInformationsForSell[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int houseList_length = reader.read_ui16();
                    ...
                    this.houseList = new com.ankamagames.dofus.network.types.game.house.HouseInformationsForSell[houseList_length];
