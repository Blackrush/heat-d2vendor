...
public class GuildInformationsPaddocksMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 5959;
        ...
        public com.ankamagames.dofus.network.types.game.paddock.PaddockContentInformations[] paddocksInformations;
    

    public GuildInformationsPaddocksMessage() { }

    
        public GuildInformationsPaddocksMessage(byte nbPaddockMax, com.ankamagames.dofus.network.types.game.paddock.PaddockContentInformations[] paddocksInformations) {
        ...
        public GuildInformationsPaddocksMessage(byte nbPaddockMax, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.paddock.PaddockContentInformations> paddocksInformations) {
                ...
                this.paddocksInformations = paddocksInformations.toArray(com.ankamagames.dofus.network.types.game.paddock.PaddockContentInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int paddocksInformations_length = reader.read_ui16();
                    ...
                    this.paddocksInformations = new com.ankamagames.dofus.network.types.game.paddock.PaddockContentInformations[paddocksInformations_length];

                    for (int i = 0; i < paddocksInformations_length; i++) {
                        
                            com.ankamagames.dofus.network.types.game.paddock.PaddockContentInformations paddocksInformations_it =
