...
public class CompassUpdateMessage extends NetworkMessage {
    ...
    public CompassUpdateMessage() { }
        ...
        public CompassUpdateMessage(byte type, com.ankamagames.dofus.network.types.game.context.MapCoordinates coords) {
    ...
    public void deserialize(DataReader reader) {
                ...
                this.type = reader.read_i8();
                    ...
                    this.coords = (com.ankamagames.dofus.network.types.game.context.MapCoordinates) InternalProtocolTypeManager.get(coords_typeId);
