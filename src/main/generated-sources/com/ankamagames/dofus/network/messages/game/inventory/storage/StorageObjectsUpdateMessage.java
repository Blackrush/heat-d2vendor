...
public class StorageObjectsUpdateMessage extends NetworkMessage {
    ...
    public StorageObjectsUpdateMessage() { }
        ...
        public StorageObjectsUpdateMessage(com.ankamagames.dofus.network.types.game.data.items.ObjectItem[] objectList) {
        ...
        public StorageObjectsUpdateMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.ObjectItem> objectList) {
            

            
                
                this.objectList = objectList.toArray(com.ankamagames.dofus.network.types.game.data.items.ObjectItem[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int objectList_length = reader.read_ui16();
                    ...
                    this.objectList = new com.ankamagames.dofus.network.types.game.data.items.ObjectItem[objectList_length];
