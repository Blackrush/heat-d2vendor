...
public class GameDataPaddockObjectListAddMessage extends NetworkMessage {
    ...
    public GameDataPaddockObjectListAddMessage() { }
        ...
        public GameDataPaddockObjectListAddMessage(com.ankamagames.dofus.network.types.game.paddock.PaddockItem[] paddockItemDescription) {
        ...
        public GameDataPaddockObjectListAddMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.paddock.PaddockItem> paddockItemDescription) {
            

            
                
                this.paddockItemDescription = paddockItemDescription.toArray(com.ankamagames.dofus.network.types.game.paddock.PaddockItem[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int paddockItemDescription_length = reader.read_ui16();
                    ...
                    this.paddockItemDescription = new com.ankamagames.dofus.network.types.game.paddock.PaddockItem[paddockItemDescription_length];
