...
public class AllianceListMessage extends NetworkMessage {
    ...
    public AllianceListMessage() { }
        ...
        public AllianceListMessage(com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations[] alliances) {
        ...
        public AllianceListMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations> alliances) {
            

            
                
                this.alliances = alliances.toArray(com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int alliances_length = reader.read_ui16();
                    ...
                    this.alliances = new com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations[alliances_length];
