...
public class ExchangeShopStockMultiMovementUpdatedMessage extends NetworkMessage {
    ...
    public ExchangeShopStockMultiMovementUpdatedMessage() { }
        ...
        public ExchangeShopStockMultiMovementUpdatedMessage(com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSell[] objectInfoList) {
        ...
        public ExchangeShopStockMultiMovementUpdatedMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSell> objectInfoList) {
            

            
                
                this.objectInfoList = objectInfoList.toArray(com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSell[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int objectInfoList_length = reader.read_ui16();
                    ...
                    this.objectInfoList = new com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSell[objectInfoList_length];
