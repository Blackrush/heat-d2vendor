...
public class ExchangeStartedMountStockMessage extends NetworkMessage {
    ...
    public ExchangeStartedMountStockMessage() { }
        ...
        public ExchangeStartedMountStockMessage(com.ankamagames.dofus.network.types.game.data.items.ObjectItem[] objectsInfos) {
        ...
        public ExchangeStartedMountStockMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.ObjectItem> objectsInfos) {
            

            
                
                this.objectsInfos = objectsInfos.toArray(com.ankamagames.dofus.network.types.game.data.items.ObjectItem[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int objectsInfos_length = reader.read_ui16();
                    ...
                    this.objectsInfos = new com.ankamagames.dofus.network.types.game.data.items.ObjectItem[objectsInfos_length];
