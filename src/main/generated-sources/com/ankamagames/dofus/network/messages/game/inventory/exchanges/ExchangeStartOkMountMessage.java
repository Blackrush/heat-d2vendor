...
public class ExchangeStartOkMountMessage extends com.ankamagames.dofus.network.messages.game.inventory.exchanges.ExchangeStartOkMountWithOutPaddockMessage {
    public static final int PROTOCOL_ID = 5979;

    
        // array,com.ankamagames.dofus.network.types.game.mount.MountClientData
        public com.ankamagames.dofus.network.types.game.mount.MountClientData[] paddockedMountsDescription;
    

    public ExchangeStartOkMountMessage() { }

    
        public ExchangeStartOkMountMessage(com.ankamagames.dofus.network.types.game.mount.MountClientData[] stabledMountsDescription, com.ankamagames.dofus.network.types.game.mount.MountClientData[] paddockedMountsDescription) {
        ...
        public ExchangeStartOkMountMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.mount.MountClientData> stabledMountsDescription, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.mount.MountClientData> paddockedMountsDescription) {
            ...
            super(stabledMountsDescription);
                ...
                this.paddockedMountsDescription = paddockedMountsDescription.toArray(com.ankamagames.dofus.network.types.game.mount.MountClientData[]::new);
    ...
    public void deserialize(DataReader reader) {
        ...
        super.deserialize(reader);
                ...
                int paddockedMountsDescription_length = reader.read_ui16();
                    ...
                    this.paddockedMountsDescription = new com.ankamagames.dofus.network.types.game.mount.MountClientData[paddockedMountsDescription_length];
