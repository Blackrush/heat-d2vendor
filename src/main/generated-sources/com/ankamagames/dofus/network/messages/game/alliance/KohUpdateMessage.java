...
public class KohUpdateMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 6439;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.BasicAllianceInformations allianceMapWinner;
    ...
    public KohUpdateMessage() { }
        ...
        public KohUpdateMessage(com.ankamagames.dofus.network.types.game.context.roleplay.AllianceInformations[] alliances, short[] allianceNbMembers, int[] allianceRoundWeigth, byte[] allianceMatchScore, com.ankamagames.dofus.network.types.game.context.roleplay.BasicAllianceInformations allianceMapWinner, int allianceMapWinnerScore, int allianceMapMyAllianceScore, double nextTickTime) {
        ...
        public KohUpdateMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.roleplay.AllianceInformations> alliances, short[] allianceNbMembers, int[] allianceRoundWeigth, byte[] allianceMatchScore, com.ankamagames.dofus.network.types.game.context.roleplay.BasicAllianceInformations allianceMapWinner, int allianceMapWinnerScore, int allianceMapMyAllianceScore, double nextTickTime) {
            

            
                
                this.alliances = alliances.toArray(com.ankamagames.dofus.network.types.game.context.roleplay.AllianceInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int alliances_length = reader.read_ui16();
                    ...
                    this.alliances = new com.ankamagames.dofus.network.types.game.context.roleplay.AllianceInformations[alliances_length];
                ...
                int allianceMatchScore_length = reader.read_ui16();
                    ...
                    this.allianceMapWinner = new com.ankamagames.dofus.network.types.game.context.roleplay.BasicAllianceInformations();
    ...
    public String toString() {
        ...
        return "KohUpdateMessage(" +
            ...
            + this.allianceMatchScore.length + "b" +
