...
public class GuildFactsMessage extends NetworkMessage {
    ...
    public GuildFactsMessage() { }
        ...
        public GuildFactsMessage(com.ankamagames.dofus.network.types.game.social.GuildFactSheetInformations infos, int creationDate, short nbTaxCollectors, boolean enabled, com.ankamagames.dofus.network.types.game.character.CharacterMinimalInformations[] members) {
        ...
        public GuildFactsMessage(com.ankamagames.dofus.network.types.game.social.GuildFactSheetInformations infos, int creationDate, short nbTaxCollectors, boolean enabled, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.character.CharacterMinimalInformations> members) {
                ...
                this.members = members.toArray(com.ankamagames.dofus.network.types.game.character.CharacterMinimalInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.infos = (com.ankamagames.dofus.network.types.game.social.GuildFactSheetInformations) InternalProtocolTypeManager.get(infos_typeId);
                ...
                int members_length = reader.read_ui16();
                    ...
                    this.members = new com.ankamagames.dofus.network.types.game.character.CharacterMinimalInformations[members_length];
