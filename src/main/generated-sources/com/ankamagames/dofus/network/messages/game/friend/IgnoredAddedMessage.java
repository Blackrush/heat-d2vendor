...
public class IgnoredAddedMessage extends NetworkMessage {
    ...
    public IgnoredAddedMessage() { }
        ...
        public IgnoredAddedMessage(com.ankamagames.dofus.network.types.game.friend.IgnoredInformations ignoreAdded, boolean session) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.ignoreAdded = (com.ankamagames.dofus.network.types.game.friend.IgnoredInformations) InternalProtocolTypeManager.get(ignoreAdded_typeId);
