...
public class PrismFightAttackerAddMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 5893;
        ...
        public com.ankamagames.dofus.network.types.game.character.CharacterMinimalPlusLookInformations attacker;
    

    public PrismFightAttackerAddMessage() { }

    
        public PrismFightAttackerAddMessage(short subAreaId, short fightId, com.ankamagames.dofus.network.types.game.character.CharacterMinimalPlusLookInformations attacker) {
    ...
    public void deserialize(DataReader reader) {
                ...
                this.fightId = reader.read_vi16();
                    ...
                    this.attacker = (com.ankamagames.dofus.network.types.game.character.CharacterMinimalPlusLookInformations) InternalProtocolTypeManager.get(attacker_typeId);
