...
public class AchievementListMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 6205;
        ...
        public com.ankamagames.dofus.network.types.game.achievement.AchievementRewardable[] rewardableAchievements;
    

    public AchievementListMessage() { }

    
        public AchievementListMessage(short[] finishedAchievementsIds, com.ankamagames.dofus.network.types.game.achievement.AchievementRewardable[] rewardableAchievements) {
        ...
        public AchievementListMessage(short[] finishedAchievementsIds, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.achievement.AchievementRewardable> rewardableAchievements) {
                ...
                this.rewardableAchievements = rewardableAchievements.toArray(com.ankamagames.dofus.network.types.game.achievement.AchievementRewardable[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int rewardableAchievements_length = reader.read_ui16();
                    ...
                    this.rewardableAchievements = new com.ankamagames.dofus.network.types.game.achievement.AchievementRewardable[rewardableAchievements_length];

                    for (int i = 0; i < rewardableAchievements_length; i++) {
                        
                            com.ankamagames.dofus.network.types.game.achievement.AchievementRewardable rewardableAchievements_it =
