...
public class JobCrafterDirectoryDefineSettingsMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 5649;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectorySettings settings;
    

    public JobCrafterDirectoryDefineSettingsMessage() { }

    
        public JobCrafterDirectoryDefineSettingsMessage(com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectorySettings settings) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.settings = new com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectorySettings();
