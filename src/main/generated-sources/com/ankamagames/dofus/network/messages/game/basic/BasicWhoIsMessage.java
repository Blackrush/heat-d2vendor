...
public class BasicWhoIsMessage extends NetworkMessage {
    ...
    public BasicWhoIsMessage() { }
        ...
        public BasicWhoIsMessage(boolean self, boolean verbose, byte position, java.lang.String accountNickname, int accountId, java.lang.String playerName, int playerId, short areaId, com.ankamagames.dofus.network.types.game.social.AbstractSocialGroupInfos[] socialGroups, byte playerState) {
        ...
        public BasicWhoIsMessage(boolean self, boolean verbose, byte position, java.lang.String accountNickname, int accountId, java.lang.String playerName, int playerId, short areaId, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.social.AbstractSocialGroupInfos> socialGroups, byte playerState) {
                ...
                this.socialGroups = socialGroups.toArray(com.ankamagames.dofus.network.types.game.social.AbstractSocialGroupInfos[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int socialGroups_length = reader.read_ui16();
                    ...
                    this.socialGroups = new com.ankamagames.dofus.network.types.game.social.AbstractSocialGroupInfos[socialGroups_length];

                    for (int i = 0; i < socialGroups_length; i++) {
                        
                            int socialGroups_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.social.AbstractSocialGroupInfos socialGroups_it = (com.ankamagames.dofus.network.types.game.social.AbstractSocialGroupInfos)
