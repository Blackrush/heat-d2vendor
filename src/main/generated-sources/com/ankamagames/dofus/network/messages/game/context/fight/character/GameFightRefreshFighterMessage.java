...
public class GameFightRefreshFighterMessage extends NetworkMessage {
    ...
    public GameFightRefreshFighterMessage() { }
        ...
        public GameFightRefreshFighterMessage(com.ankamagames.dofus.network.types.game.context.GameContextActorInformations informations) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.informations = (com.ankamagames.dofus.network.types.game.context.GameContextActorInformations) InternalProtocolTypeManager.get(informations_typeId);
