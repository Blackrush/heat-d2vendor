...
public class PaddockToSellListMessage extends NetworkMessage {
    ...
    public PaddockToSellListMessage() { }
        ...
        public PaddockToSellListMessage(short pageIndex, short totalPage, com.ankamagames.dofus.network.types.game.paddock.PaddockInformationsForSell[] paddockList) {
        ...
        public PaddockToSellListMessage(short pageIndex, short totalPage, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.paddock.PaddockInformationsForSell> paddockList) {
                ...
                this.paddockList = paddockList.toArray(com.ankamagames.dofus.network.types.game.paddock.PaddockInformationsForSell[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int paddockList_length = reader.read_ui16();
                    ...
                    this.paddockList = new com.ankamagames.dofus.network.types.game.paddock.PaddockInformationsForSell[paddockList_length];
