...
public class GuildVersatileInfoListMessage extends NetworkMessage {
    ...
    public GuildVersatileInfoListMessage() { }
        ...
        public GuildVersatileInfoListMessage(com.ankamagames.dofus.network.types.game.social.GuildVersatileInformations[] guilds) {
        ...
        public GuildVersatileInfoListMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.social.GuildVersatileInformations> guilds) {
            

            
                
                this.guilds = guilds.toArray(com.ankamagames.dofus.network.types.game.social.GuildVersatileInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int guilds_length = reader.read_ui16();
                    ...
                    this.guilds = new com.ankamagames.dofus.network.types.game.social.GuildVersatileInformations[guilds_length];

                    for (int i = 0; i < guilds_length; i++) {
                        
                            int guilds_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.social.GuildVersatileInformations guilds_it = (com.ankamagames.dofus.network.types.game.social.GuildVersatileInformations)
