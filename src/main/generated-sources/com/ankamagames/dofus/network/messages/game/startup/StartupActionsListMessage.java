...
public class StartupActionsListMessage extends NetworkMessage {
    ...
    public StartupActionsListMessage() { }
        ...
        public StartupActionsListMessage(com.ankamagames.dofus.network.types.game.startup.StartupActionAddObject[] actions) {
        ...
        public StartupActionsListMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.startup.StartupActionAddObject> actions) {
            

            
                
                this.actions = actions.toArray(com.ankamagames.dofus.network.types.game.startup.StartupActionAddObject[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int actions_length = reader.read_ui16();
                    ...
                    this.actions = new com.ankamagames.dofus.network.types.game.startup.StartupActionAddObject[actions_length];
