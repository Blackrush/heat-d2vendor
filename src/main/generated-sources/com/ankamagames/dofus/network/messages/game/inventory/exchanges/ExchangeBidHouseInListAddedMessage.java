...
public class ExchangeBidHouseInListAddedMessage extends NetworkMessage {
    ...
    public ExchangeBidHouseInListAddedMessage() { }
        ...
        public ExchangeBidHouseInListAddedMessage(int itemUID, int objGenericId, com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect[] effects, int[] prices) {
        ...
        public ExchangeBidHouseInListAddedMessage(int itemUID, int objGenericId, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect> effects, int[] prices) {
    ...
    public void serialize(DataWriter writer) {
                ...
                writer.write_i32(this.objGenericId);
                    ...
                    writer.write_array_vi32(this.prices);
    ...
    public void deserialize(DataReader reader) {
                ...
                int prices_length = reader.read_ui16();
                    ...
                    this.prices = reader.read_array_vi32(prices_length);
