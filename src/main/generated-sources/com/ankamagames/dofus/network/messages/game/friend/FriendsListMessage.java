...
public class FriendsListMessage extends NetworkMessage {
    ...
    public FriendsListMessage() { }
        ...
        public FriendsListMessage(com.ankamagames.dofus.network.types.game.friend.FriendInformations[] friendsList) {
        ...
        public FriendsListMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.friend.FriendInformations> friendsList) {
            

            
                
                this.friendsList = friendsList.toArray(com.ankamagames.dofus.network.types.game.friend.FriendInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int friendsList_length = reader.read_ui16();
                    ...
                    this.friendsList = new com.ankamagames.dofus.network.types.game.friend.FriendInformations[friendsList_length];

                    for (int i = 0; i < friendsList_length; i++) {
                        
                            int friendsList_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.friend.FriendInformations friendsList_it = (com.ankamagames.dofus.network.types.game.friend.FriendInformations)
