...
public class MapComplementaryInformationsDataMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 226;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayActorInformations[] actors;
    
        // array,com.ankamagames.dofus.network.types.game.interactive.InteractiveElement
        public com.ankamagames.dofus.network.types.game.interactive.InteractiveElement[] interactiveElements;
    ...
    public MapComplementaryInformationsDataMessage() { }
        ...
        public MapComplementaryInformationsDataMessage(short subAreaId, int mapId, com.ankamagames.dofus.network.types.game.house.HouseInformations[] houses, com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayActorInformations[] actors, com.ankamagames.dofus.network.types.game.interactive.InteractiveElement[] interactiveElements, com.ankamagames.dofus.network.types.game.interactive.StatedElement[] statedElements, com.ankamagames.dofus.network.types.game.interactive.MapObstacle[] obstacles, com.ankamagames.dofus.network.types.game.context.fight.FightCommonInformations[] fights) {
        ...
        public MapComplementaryInformationsDataMessage(short subAreaId, int mapId, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.house.HouseInformations> houses, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayActorInformations> actors, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.interactive.InteractiveElement> interactiveElements, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.interactive.StatedElement> statedElements, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.interactive.MapObstacle> obstacles, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.fight.FightCommonInformations> fights) {
                ...
                this.houses = houses.toArray(com.ankamagames.dofus.network.types.game.house.HouseInformations[]::new);
                
            
                
                this.actors = actors.toArray(com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayActorInformations[]::new);
                
            
                
                this.interactiveElements = interactiveElements.toArray(com.ankamagames.dofus.network.types.game.interactive.InteractiveElement[]::new);
                
            
                
                this.statedElements = statedElements.toArray(com.ankamagames.dofus.network.types.game.interactive.StatedElement[]::new);
                
            
                
                this.obstacles = obstacles.toArray(com.ankamagames.dofus.network.types.game.interactive.MapObstacle[]::new);
                
            
                
                this.fights = fights.toArray(com.ankamagames.dofus.network.types.game.context.fight.FightCommonInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int houses_length = reader.read_ui16();
                    ...
                    this.houses = new com.ankamagames.dofus.network.types.game.house.HouseInformations[houses_length];

                    for (int i = 0; i < houses_length; i++) {
                        
                            int houses_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.house.HouseInformations houses_it = (com.ankamagames.dofus.network.types.game.house.HouseInformations)
                ...
                int actors_length = reader.read_ui16();
                    ...
                    this.actors = new com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayActorInformations[actors_length];

                    for (int i = 0; i < actors_length; i++) {
                        
                            int actors_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayActorInformations actors_it = (com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayActorInformations)
                ...
                int interactiveElements_length = reader.read_ui16();
                    ...
                    this.interactiveElements = new com.ankamagames.dofus.network.types.game.interactive.InteractiveElement[interactiveElements_length];

                    for (int i = 0; i < interactiveElements_length; i++) {
                        
                            int interactiveElements_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.interactive.InteractiveElement interactiveElements_it = (com.ankamagames.dofus.network.types.game.interactive.InteractiveElement)
                ...
                int statedElements_length = reader.read_ui16();
                    ...
                    this.statedElements = new com.ankamagames.dofus.network.types.game.interactive.StatedElement[statedElements_length];
                ...
                int obstacles_length = reader.read_ui16();
                    ...
                    this.obstacles = new com.ankamagames.dofus.network.types.game.interactive.MapObstacle[obstacles_length];
                ...
                int fights_length = reader.read_ui16();
                    ...
                    this.fights = new com.ankamagames.dofus.network.types.game.context.fight.FightCommonInformations[fights_length];
