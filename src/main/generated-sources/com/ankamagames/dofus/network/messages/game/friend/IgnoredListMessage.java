...
public class IgnoredListMessage extends NetworkMessage {
    ...
    public IgnoredListMessage() { }
        ...
        public IgnoredListMessage(com.ankamagames.dofus.network.types.game.friend.IgnoredInformations[] ignoredList) {
        ...
        public IgnoredListMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.friend.IgnoredInformations> ignoredList) {
            

            
                
                this.ignoredList = ignoredList.toArray(com.ankamagames.dofus.network.types.game.friend.IgnoredInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int ignoredList_length = reader.read_ui16();
                    ...
                    this.ignoredList = new com.ankamagames.dofus.network.types.game.friend.IgnoredInformations[ignoredList_length];

                    for (int i = 0; i < ignoredList_length; i++) {
                        
                            int ignoredList_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.friend.IgnoredInformations ignoredList_it = (com.ankamagames.dofus.network.types.game.friend.IgnoredInformations)
