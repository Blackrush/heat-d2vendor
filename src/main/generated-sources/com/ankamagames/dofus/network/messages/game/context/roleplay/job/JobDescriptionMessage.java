...
public class JobDescriptionMessage extends NetworkMessage {
    ...
    public JobDescriptionMessage() { }
        ...
        public JobDescriptionMessage(com.ankamagames.dofus.network.types.game.context.roleplay.job.JobDescription[] jobsDescription) {
        ...
        public JobDescriptionMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.roleplay.job.JobDescription> jobsDescription) {
            

            
                
                this.jobsDescription = jobsDescription.toArray(com.ankamagames.dofus.network.types.game.context.roleplay.job.JobDescription[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int jobsDescription_length = reader.read_ui16();
                    ...
                    this.jobsDescription = new com.ankamagames.dofus.network.types.game.context.roleplay.job.JobDescription[jobsDescription_length];

                    for (int i = 0; i < jobsDescription_length; i++) {
                        
                            com.ankamagames.dofus.network.types.game.context.roleplay.job.JobDescription jobsDescription_it =
