...
public class ServerSessionConstantsMessage extends NetworkMessage {
    ...
    public ServerSessionConstantsMessage() { }
        ...
        public ServerSessionConstantsMessage(com.ankamagames.dofus.network.types.game.approach.ServerSessionConstant[] variables) {
        ...
        public ServerSessionConstantsMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.approach.ServerSessionConstant> variables) {
            

            
                
                this.variables = variables.toArray(com.ankamagames.dofus.network.types.game.approach.ServerSessionConstant[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int variables_length = reader.read_ui16();
                    ...
                    this.variables = new com.ankamagames.dofus.network.types.game.approach.ServerSessionConstant[variables_length];

                    for (int i = 0; i < variables_length; i++) {
                        
                            int variables_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.approach.ServerSessionConstant variables_it = (com.ankamagames.dofus.network.types.game.approach.ServerSessionConstant)
