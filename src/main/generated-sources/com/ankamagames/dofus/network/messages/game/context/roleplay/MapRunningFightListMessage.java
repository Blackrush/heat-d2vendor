...
public class MapRunningFightListMessage extends NetworkMessage {
    ...
    public MapRunningFightListMessage() { }
        ...
        public MapRunningFightListMessage(com.ankamagames.dofus.network.types.game.context.fight.FightExternalInformations[] fights) {
        ...
        public MapRunningFightListMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.fight.FightExternalInformations> fights) {
            

            
                
                this.fights = fights.toArray(com.ankamagames.dofus.network.types.game.context.fight.FightExternalInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int fights_length = reader.read_ui16();
                    ...
                    this.fights = new com.ankamagames.dofus.network.types.game.context.fight.FightExternalInformations[fights_length];
