...
public class TeleportDestinationsListMessage extends NetworkMessage {
    ...
    public TeleportDestinationsListMessage() { }
        ...
        public TeleportDestinationsListMessage(byte teleporterType, int[] mapIds, short[] subAreaIds, short[] costs, byte[] destTeleporterType) {
    ...
    public void serialize(DataWriter writer) {
                ...
                writer.write_i8(this.teleporterType);
                    ...
                    writer.write_array_i32(this.mapIds);
    ...
    public void deserialize(DataReader reader) {
                ...
                int mapIds_length = reader.read_ui16();
                    ...
                    this.mapIds = reader.read_array_i32(mapIds_length);
