...
public class ObjectsQuantityMessage extends NetworkMessage {
    ...
    public ObjectsQuantityMessage() { }
        ...
        public ObjectsQuantityMessage(com.ankamagames.dofus.network.types.game.data.items.ObjectItemQuantity[] objectsUIDAndQty) {
        ...
        public ObjectsQuantityMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.ObjectItemQuantity> objectsUIDAndQty) {
            

            
                
                this.objectsUIDAndQty = objectsUIDAndQty.toArray(com.ankamagames.dofus.network.types.game.data.items.ObjectItemQuantity[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int objectsUIDAndQty_length = reader.read_ui16();
                    ...
                    this.objectsUIDAndQty = new com.ankamagames.dofus.network.types.game.data.items.ObjectItemQuantity[objectsUIDAndQty_length];
