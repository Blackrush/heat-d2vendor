...
public class JobCrafterDirectoryEntryMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 6044;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryPlayerInfo playerInfo;
    
        // array,com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo
        public com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo[] jobInfoList;
    ...
    public JobCrafterDirectoryEntryMessage() { }
        ...
        public JobCrafterDirectoryEntryMessage(com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryPlayerInfo playerInfo, com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo[] jobInfoList, com.ankamagames.dofus.network.types.game.look.EntityLook playerLook) {
        ...
        public JobCrafterDirectoryEntryMessage(com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryPlayerInfo playerInfo, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo> jobInfoList, com.ankamagames.dofus.network.types.game.look.EntityLook playerLook) {
                ...
                this.jobInfoList = jobInfoList.toArray(com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int jobInfoList_length = reader.read_ui16();
                    ...
                    this.jobInfoList = new com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo[jobInfoList_length];

                    for (int i = 0; i < jobInfoList_length; i++) {
                        
                            com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo jobInfoList_it =
                                    new com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo();
