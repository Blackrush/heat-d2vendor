...
public class FriendAddedMessage extends NetworkMessage {
    ...
    public FriendAddedMessage() { }
        ...
        public FriendAddedMessage(com.ankamagames.dofus.network.types.game.friend.FriendInformations friendAdded) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.friendAdded = (com.ankamagames.dofus.network.types.game.friend.FriendInformations) InternalProtocolTypeManager.get(friendAdded_typeId);
