...
public class GuildListMessage extends NetworkMessage {
    ...
    public GuildListMessage() { }
        ...
        public GuildListMessage(com.ankamagames.dofus.network.types.game.context.roleplay.GuildInformations[] guilds) {
        ...
        public GuildListMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.roleplay.GuildInformations> guilds) {
            

            
                
                this.guilds = guilds.toArray(com.ankamagames.dofus.network.types.game.context.roleplay.GuildInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int guilds_length = reader.read_ui16();
                    ...
                    this.guilds = new com.ankamagames.dofus.network.types.game.context.roleplay.GuildInformations[guilds_length];
