...
public class InteractiveElementUpdatedMessage extends NetworkMessage {
    ...
    public InteractiveElementUpdatedMessage() { }
        ...
        public InteractiveElementUpdatedMessage(com.ankamagames.dofus.network.types.game.interactive.InteractiveElement interactiveElement) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.interactiveElement = new com.ankamagames.dofus.network.types.game.interactive.InteractiveElement();
