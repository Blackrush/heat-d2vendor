...
public class TreasureHuntMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 6486;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntStep[] knownStepsList;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntFlag[] flags;
    

    public TreasureHuntMessage() { }

    
        public TreasureHuntMessage(byte questType, int startMapId, com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntStep[] knownStepsList, byte totalStepCount, int checkPointCurrent, int checkPointTotal, int availableRetryCount, com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntFlag[] flags) {
        ...
        public TreasureHuntMessage(byte questType, int startMapId, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntStep> knownStepsList, byte totalStepCount, int checkPointCurrent, int checkPointTotal, int availableRetryCount, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntFlag> flags) {
                ...
                this.knownStepsList = knownStepsList.toArray(com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntStep[]::new);
                ...
                this.flags = flags.toArray(com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntFlag[]::new);
    ...
    public void serialize(DataWriter writer) {
                ...
                writer.write_i32(this.startMapId);
    ...
    public void deserialize(DataReader reader) {
                ...
                this.startMapId = reader.read_i32();
                ...
                int knownStepsList_length = reader.read_ui16();
                    ...
                    this.knownStepsList = new com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntStep[knownStepsList_length];

                    for (int i = 0; i < knownStepsList_length; i++) {
                        
                            int knownStepsList_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntStep knownStepsList_it = (com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntStep)
                ...
                int flags_length = reader.read_ui16();
                    ...
                    this.flags = new com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntFlag[flags_length];

                    for (int i = 0; i < flags_length; i++) {
                        
                            com.ankamagames.dofus.network.types.game.context.roleplay.treasureHunt.TreasureHuntFlag flags_it =
