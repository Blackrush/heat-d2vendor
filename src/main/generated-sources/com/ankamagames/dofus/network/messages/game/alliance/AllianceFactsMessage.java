...
public class AllianceFactsMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 6414;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.GuildInAllianceInformations[] guilds;
    ...
    public AllianceFactsMessage() { }
        ...
        public AllianceFactsMessage(com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations infos, com.ankamagames.dofus.network.types.game.context.roleplay.GuildInAllianceInformations[] guilds, short[] controlledSubareaIds, int leaderCharacterId, java.lang.String leaderCharacterName) {
        ...
        public AllianceFactsMessage(com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations infos, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.roleplay.GuildInAllianceInformations> guilds, short[] controlledSubareaIds, int leaderCharacterId, java.lang.String leaderCharacterName) {
                ...
                this.guilds = guilds.toArray(com.ankamagames.dofus.network.types.game.context.roleplay.GuildInAllianceInformations[]::new);
    ...
    public void serialize(DataWriter writer) {
            ...
            this.infos.serialize(writer);
                ...
                writer.write_vi32(this.leaderCharacterId);
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.infos = (com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations) InternalProtocolTypeManager.get(infos_typeId);
                ...
                int guilds_length = reader.read_ui16();
                    ...
                    this.guilds = new com.ankamagames.dofus.network.types.game.context.roleplay.GuildInAllianceInformations[guilds_length];

                    for (int i = 0; i < guilds_length; i++) {
                        
                            com.ankamagames.dofus.network.types.game.context.roleplay.GuildInAllianceInformations guilds_it =
                ...
                this.leaderCharacterId = reader.read_vi32();
