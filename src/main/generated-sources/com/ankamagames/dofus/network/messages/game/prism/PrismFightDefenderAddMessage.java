...
public class PrismFightDefenderAddMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 5895;
        ...
        public com.ankamagames.dofus.network.types.game.character.CharacterMinimalPlusLookInformations defender;
    

    public PrismFightDefenderAddMessage() { }

    
        public PrismFightDefenderAddMessage(short subAreaId, short fightId, com.ankamagames.dofus.network.types.game.character.CharacterMinimalPlusLookInformations defender) {
    ...
    public void deserialize(DataReader reader) {
                ...
                this.fightId = reader.read_vi16();
                    ...
                    this.defender = (com.ankamagames.dofus.network.types.game.character.CharacterMinimalPlusLookInformations) InternalProtocolTypeManager.get(defender_typeId);
