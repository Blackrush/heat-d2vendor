...
public class CharactersListWithModificationsMessage extends com.ankamagames.dofus.network.messages.game.character.choice.CharactersListMessage {
    public static final int PROTOCOL_ID = 6120;
        ...
        public com.ankamagames.dofus.network.types.game.character.choice.CharacterToRecolorInformation[] charactersToRecolor;
        ...
        public com.ankamagames.dofus.network.types.game.character.choice.CharacterToRelookInformation[] charactersToRelook;
    

    public CharactersListWithModificationsMessage() { }

    
        public CharactersListWithModificationsMessage(com.ankamagames.dofus.network.types.game.character.choice.CharacterBaseInformations[] characters, boolean hasStartupActions, com.ankamagames.dofus.network.types.game.character.choice.CharacterToRecolorInformation[] charactersToRecolor, int[] charactersToRename, int[] unusableCharacters, com.ankamagames.dofus.network.types.game.character.choice.CharacterToRelookInformation[] charactersToRelook) {
        ...
        public CharactersListWithModificationsMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.character.choice.CharacterBaseInformations> characters, boolean hasStartupActions, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.character.choice.CharacterToRecolorInformation> charactersToRecolor, int[] charactersToRename, int[] unusableCharacters, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.character.choice.CharacterToRelookInformation> charactersToRelook) {
            ...
            super(characters, hasStartupActions);
                ...
                this.charactersToRecolor = charactersToRecolor.toArray(com.ankamagames.dofus.network.types.game.character.choice.CharacterToRecolorInformation[]::new);
                ...
                this.charactersToRelook = charactersToRelook.toArray(com.ankamagames.dofus.network.types.game.character.choice.CharacterToRelookInformation[]::new);
    ...
    public void deserialize(DataReader reader) {
        ...
        super.deserialize(reader);
                ...
                int charactersToRecolor_length = reader.read_ui16();
                    ...
                    this.charactersToRecolor = new com.ankamagames.dofus.network.types.game.character.choice.CharacterToRecolorInformation[charactersToRecolor_length];

                    for (int i = 0; i < charactersToRecolor_length; i++) {
                        
                            com.ankamagames.dofus.network.types.game.character.choice.CharacterToRecolorInformation charactersToRecolor_it =
                ...
                int charactersToRelook_length = reader.read_ui16();
                    ...
                    this.charactersToRelook = new com.ankamagames.dofus.network.types.game.character.choice.CharacterToRelookInformation[charactersToRelook_length];

                    for (int i = 0; i < charactersToRelook_length; i++) {
                        
                            com.ankamagames.dofus.network.types.game.character.choice.CharacterToRelookInformation charactersToRelook_it =
