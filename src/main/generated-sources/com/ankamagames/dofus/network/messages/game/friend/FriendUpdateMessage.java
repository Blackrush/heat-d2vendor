...
public class FriendUpdateMessage extends NetworkMessage {
    ...
    public FriendUpdateMessage() { }
        ...
        public FriendUpdateMessage(com.ankamagames.dofus.network.types.game.friend.FriendInformations friendUpdated) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.friendUpdated = (com.ankamagames.dofus.network.types.game.friend.FriendInformations) InternalProtocolTypeManager.get(friendUpdated_typeId);
