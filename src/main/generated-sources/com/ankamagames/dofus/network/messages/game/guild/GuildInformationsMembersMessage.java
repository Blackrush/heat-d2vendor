...
public class GuildInformationsMembersMessage extends NetworkMessage {
    ...
    public GuildInformationsMembersMessage() { }
        ...
        public GuildInformationsMembersMessage(com.ankamagames.dofus.network.types.game.guild.GuildMember[] members) {
        ...
        public GuildInformationsMembersMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.guild.GuildMember> members) {
            

            
                
                this.members = members.toArray(com.ankamagames.dofus.network.types.game.guild.GuildMember[]::new);
