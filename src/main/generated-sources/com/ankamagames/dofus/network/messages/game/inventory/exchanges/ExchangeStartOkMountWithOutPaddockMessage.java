...
public class ExchangeStartOkMountWithOutPaddockMessage extends NetworkMessage {
    ...
    public ExchangeStartOkMountWithOutPaddockMessage() { }
        ...
        public ExchangeStartOkMountWithOutPaddockMessage(com.ankamagames.dofus.network.types.game.mount.MountClientData[] stabledMountsDescription) {
        ...
        public ExchangeStartOkMountWithOutPaddockMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.mount.MountClientData> stabledMountsDescription) {
            

            
                
                this.stabledMountsDescription = stabledMountsDescription.toArray(com.ankamagames.dofus.network.types.game.mount.MountClientData[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int stabledMountsDescription_length = reader.read_ui16();
                    ...
                    this.stabledMountsDescription = new com.ankamagames.dofus.network.types.game.mount.MountClientData[stabledMountsDescription_length];
