...
public class ExchangeObjectsModifiedMessage extends com.ankamagames.dofus.network.messages.game.inventory.exchanges.ExchangeObjectMessage {
    ...
    public ExchangeObjectsModifiedMessage() { }
        ...
        public ExchangeObjectsModifiedMessage(boolean remote, com.ankamagames.dofus.network.types.game.data.items.ObjectItem[] object) {
        ...
        public ExchangeObjectsModifiedMessage(boolean remote, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.ObjectItem> object) {
            ...
            super(remote);
                ...
                this.object = object.toArray(com.ankamagames.dofus.network.types.game.data.items.ObjectItem[]::new);
