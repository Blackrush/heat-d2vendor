...
public class GameRolePlayShowChallengeMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 301;
        ...
        public com.ankamagames.dofus.network.types.game.context.fight.FightCommonInformations commonsInfos;
    

    public GameRolePlayShowChallengeMessage() { }

    
        public GameRolePlayShowChallengeMessage(com.ankamagames.dofus.network.types.game.context.fight.FightCommonInformations commonsInfos) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.commonsInfos = new com.ankamagames.dofus.network.types.game.context.fight.FightCommonInformations();
