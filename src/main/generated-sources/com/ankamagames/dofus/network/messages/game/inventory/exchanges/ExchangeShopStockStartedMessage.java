...
public class ExchangeShopStockStartedMessage extends NetworkMessage {
    ...
    public ExchangeShopStockStartedMessage() { }
        ...
        public ExchangeShopStockStartedMessage(com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSell[] objectsInfos) {
        ...
        public ExchangeShopStockStartedMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSell> objectsInfos) {
            

            
                
                this.objectsInfos = objectsInfos.toArray(com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSell[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int objectsInfos_length = reader.read_ui16();
                    ...
                    this.objectsInfos = new com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSell[objectsInfos_length];
