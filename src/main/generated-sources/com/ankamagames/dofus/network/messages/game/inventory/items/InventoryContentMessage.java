...
public class InventoryContentMessage extends NetworkMessage {
    ...
    public InventoryContentMessage() { }
        ...
        public InventoryContentMessage(com.ankamagames.dofus.network.types.game.data.items.ObjectItem[] objects, int kamas) {
        ...
        public InventoryContentMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.ObjectItem> objects, int kamas) {
