...
public class GameRolePlayShowActorMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 5632;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayActorInformations informations;
    

    public GameRolePlayShowActorMessage() { }

    
        public GameRolePlayShowActorMessage(com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayActorInformations informations) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.informations = (com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayActorInformations) InternalProtocolTypeManager.get(informations_typeId);
