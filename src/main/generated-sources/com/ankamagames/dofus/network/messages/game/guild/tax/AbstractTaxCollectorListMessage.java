...
public class AbstractTaxCollectorListMessage extends NetworkMessage {
    ...
    public AbstractTaxCollectorListMessage() { }
        ...
        public AbstractTaxCollectorListMessage(com.ankamagames.dofus.network.types.game.guild.tax.TaxCollectorInformations[] informations) {
        ...
        public AbstractTaxCollectorListMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.guild.tax.TaxCollectorInformations> informations) {
            

            
                
                this.informations = informations.toArray(com.ankamagames.dofus.network.types.game.guild.tax.TaxCollectorInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int informations_length = reader.read_ui16();
                    ...
                    this.informations = new com.ankamagames.dofus.network.types.game.guild.tax.TaxCollectorInformations[informations_length];

                    for (int i = 0; i < informations_length; i++) {
                        
                            int informations_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.guild.tax.TaxCollectorInformations informations_it = (com.ankamagames.dofus.network.types.game.guild.tax.TaxCollectorInformations)
