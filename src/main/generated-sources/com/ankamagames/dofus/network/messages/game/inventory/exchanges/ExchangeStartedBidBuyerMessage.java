...
public class ExchangeStartedBidBuyerMessage extends NetworkMessage {
    ...
    public ExchangeStartedBidBuyerMessage() { }
        ...
        public ExchangeStartedBidBuyerMessage(com.ankamagames.dofus.network.types.game.data.items.SellerBuyerDescriptor buyerDescriptor) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.buyerDescriptor = new com.ankamagames.dofus.network.types.game.data.items.SellerBuyerDescriptor();
