...
public class AccountHouseMessage extends NetworkMessage {
    ...
    public AccountHouseMessage() { }
        ...
        public AccountHouseMessage(com.ankamagames.dofus.network.types.game.house.AccountHouseInformations[] houses) {
        ...
        public AccountHouseMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.house.AccountHouseInformations> houses) {
            

            
                
                this.houses = houses.toArray(com.ankamagames.dofus.network.types.game.house.AccountHouseInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int houses_length = reader.read_ui16();
                    ...
                    this.houses = new com.ankamagames.dofus.network.types.game.house.AccountHouseInformations[houses_length];
