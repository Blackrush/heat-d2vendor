...
public class AllianceInsiderInfoMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 6403;
        ...
        public com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations allianceInfos;
    ...
    public AllianceInsiderInfoMessage() { }
        ...
        public AllianceInsiderInfoMessage(com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations allianceInfos, com.ankamagames.dofus.network.types.game.social.GuildInsiderFactSheetInformations[] guilds, com.ankamagames.dofus.network.types.game.prism.PrismSubareaEmptyInfo[] prisms) {
        ...
        public AllianceInsiderInfoMessage(com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations allianceInfos, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.social.GuildInsiderFactSheetInformations> guilds, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.prism.PrismSubareaEmptyInfo> prisms) {
                ...
                this.guilds = guilds.toArray(com.ankamagames.dofus.network.types.game.social.GuildInsiderFactSheetInformations[]::new);
                
            
                
                this.prisms = prisms.toArray(com.ankamagames.dofus.network.types.game.prism.PrismSubareaEmptyInfo[]::new);
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.allianceInfos = new com.ankamagames.dofus.network.types.game.social.AllianceFactSheetInformations();
                ...
                int guilds_length = reader.read_ui16();
                    ...
                    this.guilds = new com.ankamagames.dofus.network.types.game.social.GuildInsiderFactSheetInformations[guilds_length];
                ...
                int prisms_length = reader.read_ui16();
                    ...
                    this.prisms = new com.ankamagames.dofus.network.types.game.prism.PrismSubareaEmptyInfo[prisms_length];

                    for (int i = 0; i < prisms_length; i++) {
                        
                            int prisms_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.prism.PrismSubareaEmptyInfo prisms_it = (com.ankamagames.dofus.network.types.game.prism.PrismSubareaEmptyInfo)
