...
public class ExchangeStartedBidSellerMessage extends NetworkMessage {
    ...
    public ExchangeStartedBidSellerMessage() { }
        ...
        public ExchangeStartedBidSellerMessage(com.ankamagames.dofus.network.types.game.data.items.SellerBuyerDescriptor sellerDescriptor, com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSellInBid[] objectsInfos) {
        ...
        public ExchangeStartedBidSellerMessage(com.ankamagames.dofus.network.types.game.data.items.SellerBuyerDescriptor sellerDescriptor, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSellInBid> objectsInfos) {
                ...
                this.objectsInfos = objectsInfos.toArray(com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSellInBid[]::new);
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.sellerDescriptor = new com.ankamagames.dofus.network.types.game.data.items.SellerBuyerDescriptor();
                ...
                int objectsInfos_length = reader.read_ui16();
                    ...
                    this.objectsInfos = new com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSellInBid[objectsInfos_length];
