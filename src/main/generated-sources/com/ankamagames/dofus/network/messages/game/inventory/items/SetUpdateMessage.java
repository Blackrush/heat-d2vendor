...
public class SetUpdateMessage extends NetworkMessage {
    ...
    public SetUpdateMessage() { }
        ...
        public SetUpdateMessage(short setId, short[] setObjects, com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect[] setEffects) {
        ...
        public SetUpdateMessage(short setId, short[] setObjects, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect> setEffects) {
                ...
                this.setEffects = setEffects.toArray(com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int setEffects_length = reader.read_ui16();
                    ...
                    this.setEffects = new com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect[setEffects_length];

                    for (int i = 0; i < setEffects_length; i++) {
                        
                            int setEffects_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect setEffects_it = (com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect)
