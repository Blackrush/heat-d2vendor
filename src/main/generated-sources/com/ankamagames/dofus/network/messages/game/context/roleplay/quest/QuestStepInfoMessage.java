...
public class QuestStepInfoMessage extends NetworkMessage {
    public static final int PROTOCOL_ID = 5625;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.quest.QuestActiveInformations infos;
    

    public QuestStepInfoMessage() { }

    
        public QuestStepInfoMessage(com.ankamagames.dofus.network.types.game.context.roleplay.quest.QuestActiveInformations infos) {
    ...
    public void deserialize(DataReader reader) {
                    ...
                    this.infos = (com.ankamagames.dofus.network.types.game.context.roleplay.quest.QuestActiveInformations) InternalProtocolTypeManager.get(infos_typeId);
