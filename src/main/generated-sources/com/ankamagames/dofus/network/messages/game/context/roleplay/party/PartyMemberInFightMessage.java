...
public class PartyMemberInFightMessage extends com.ankamagames.dofus.network.messages.game.context.roleplay.party.AbstractPartyMessage {
    ...
    public PartyMemberInFightMessage() { }
        ...
        public PartyMemberInFightMessage(int partyId, byte reason, int memberId, int memberAccountId, java.lang.String memberName, int fightId, com.ankamagames.dofus.network.types.game.context.MapCoordinatesExtended fightMap, short timeBeforeFightStart) {
