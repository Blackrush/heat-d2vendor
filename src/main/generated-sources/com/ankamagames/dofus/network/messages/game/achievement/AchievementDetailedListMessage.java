...
public class AchievementDetailedListMessage extends NetworkMessage {
    ...
    public AchievementDetailedListMessage() { }
        ...
        public AchievementDetailedListMessage(com.ankamagames.dofus.network.types.game.achievement.Achievement[] startedAchievements, com.ankamagames.dofus.network.types.game.achievement.Achievement[] finishedAchievements) {
        ...
        public AchievementDetailedListMessage(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.achievement.Achievement> startedAchievements, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.achievement.Achievement> finishedAchievements) {
            

            
                
                this.startedAchievements = startedAchievements.toArray(com.ankamagames.dofus.network.types.game.achievement.Achievement[]::new);
                
            
                
                this.finishedAchievements = finishedAchievements.toArray(com.ankamagames.dofus.network.types.game.achievement.Achievement[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int startedAchievements_length = reader.read_ui16();
                    ...
                    this.startedAchievements = new com.ankamagames.dofus.network.types.game.achievement.Achievement[startedAchievements_length];
                ...
                int finishedAchievements_length = reader.read_ui16();
                    ...
                    this.finishedAchievements = new com.ankamagames.dofus.network.types.game.achievement.Achievement[finishedAchievements_length];
