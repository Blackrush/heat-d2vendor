...
public class FightTeamLightInformations extends com.ankamagames.dofus.network.types.game.context.fight.AbstractFightTeamInformations {
    ...
    public FightTeamLightInformations() { }
        ...
        public FightTeamLightInformations(byte teamId, int leaderId, byte teamSide, byte teamTypeId, byte nbWaves, boolean hasFriend, boolean hasGuildMember, boolean hasAllianceMember, boolean hasGroupMember, boolean hasMyTaxCollector, byte teamMembersCount, int meanLevel) {
