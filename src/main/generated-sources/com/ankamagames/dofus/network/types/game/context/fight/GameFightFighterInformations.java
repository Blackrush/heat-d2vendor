...
public class GameFightFighterInformations extends com.ankamagames.dofus.network.types.game.context.GameContextActorInformations {
    ...
    public GameFightFighterInformations() { }
        ...
        public GameFightFighterInformations(int contextualId, com.ankamagames.dofus.network.types.game.look.EntityLook look, com.ankamagames.dofus.network.types.game.context.EntityDispositionInformations disposition, byte teamId, byte wave, boolean alive, com.ankamagames.dofus.network.types.game.context.fight.GameFightMinimalStats stats, short[] previousPositions) {
    ...
    public void deserialize(DataReader reader) {
        ...
        super.deserialize(reader);
                ...
                this.alive = reader.read_bool();
                    ...
                    this.stats = (com.ankamagames.dofus.network.types.game.context.fight.GameFightMinimalStats) InternalProtocolTypeManager.get(stats_typeId);
