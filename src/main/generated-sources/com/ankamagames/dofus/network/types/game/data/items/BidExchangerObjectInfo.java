...
public class BidExchangerObjectInfo extends NetworkType {
    ...
    public BidExchangerObjectInfo() { }
        ...
        public BidExchangerObjectInfo(int objectUID, com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect[] effects, int[] prices) {
        ...
        public BidExchangerObjectInfo(int objectUID, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect> effects, int[] prices) {
    ...
    public void serialize(DataWriter writer) {
                ...
                writer.write_vi32(this.objectUID);
                    ...
                    writer.write_array_i32(this.prices);
    ...
    public void deserialize(DataReader reader) {
                ...
                int prices_length = reader.read_ui16();
                    ...
                    this.prices = reader.read_array_i32(prices_length);
