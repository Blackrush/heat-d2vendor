...
public class MountClientData extends NetworkType {
    public static final int PROTOCOL_ID = 178;
        ...
        public com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectInteger[] effectList;
    

    public MountClientData() { }

    
        public MountClientData(boolean sex, boolean isRideable, boolean isWild, boolean isFecondationReady, double id, int model, int[] ancestor, int[] behaviors, java.lang.String name, int ownerId, long experience, long experienceForLevel, double experienceForNextLevel, byte level, int maxPods, int stamina, int staminaMax, int maturity, int maturityForAdult, int energy, int energyMax, int serenity, int aggressivityMax, int serenityMax, int love, int loveMax, int fecondationTime, int boostLimiter, double boostMax, int reproductionCount, int reproductionCountMax, com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectInteger[] effectList) {
        ...
        public MountClientData(boolean sex, boolean isRideable, boolean isWild, boolean isFecondationReady, double id, int model, int[] ancestor, int[] behaviors, java.lang.String name, int ownerId, long experience, long experienceForLevel, double experienceForNextLevel, byte level, int maxPods, int stamina, int staminaMax, int maturity, int maturityForAdult, int energy, int energyMax, int serenity, int aggressivityMax, int serenityMax, int love, int loveMax, int fecondationTime, int boostLimiter, double boostMax, int reproductionCount, int reproductionCountMax, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectInteger> effectList) {
                ...
                this.effectList = effectList.toArray(com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectInteger[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int effectList_length = reader.read_ui16();
                    ...
                    this.effectList = new com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectInteger[effectList_length];

                    for (int i = 0; i < effectList_length; i++) {
                        
                            com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectInteger effectList_it =
