...
public class JobDescription extends NetworkType {
    ...
    public JobDescription() { }
        ...
        public JobDescription(byte jobId, com.ankamagames.dofus.network.types.game.interactive.skill.SkillActionDescription[] skills) {
        ...
        public JobDescription(byte jobId, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.interactive.skill.SkillActionDescription> skills) {
                ...
                this.skills = skills.toArray(com.ankamagames.dofus.network.types.game.interactive.skill.SkillActionDescription[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int skills_length = reader.read_ui16();
                    ...
                    this.skills = new com.ankamagames.dofus.network.types.game.interactive.skill.SkillActionDescription[skills_length];

                    for (int i = 0; i < skills_length; i++) {
                        
                            int skills_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.interactive.skill.SkillActionDescription skills_it = (com.ankamagames.dofus.network.types.game.interactive.skill.SkillActionDescription)
