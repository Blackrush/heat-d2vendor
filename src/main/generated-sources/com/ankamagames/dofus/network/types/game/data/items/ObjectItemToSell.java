...
public class ObjectItemToSell extends com.ankamagames.dofus.network.types.game.data.items.Item {
    ...
    public ObjectItemToSell() { }
        ...
        public ObjectItemToSell(short objectGID, com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect[] effects, int objectUID, int quantity, int objectPrice) {
        ...
        public ObjectItemToSell(short objectGID, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect> effects, int objectUID, int quantity, int objectPrice) {
