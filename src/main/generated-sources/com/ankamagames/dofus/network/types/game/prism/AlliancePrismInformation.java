...
public class AlliancePrismInformation extends com.ankamagames.dofus.network.types.game.prism.PrismInformation {
    ...
    public AlliancePrismInformation() { }
        ...
        public AlliancePrismInformation(byte typeId, byte state, int nextVulnerabilityDate, int placementDate, int rewardTokenCount, com.ankamagames.dofus.network.types.game.context.roleplay.AllianceInformations alliance) {
    ...
    public void deserialize(DataReader reader) {
        ...
        super.deserialize(reader);
                    ...
                    this.alliance = new com.ankamagames.dofus.network.types.game.context.roleplay.AllianceInformations();
