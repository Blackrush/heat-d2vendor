...
public class FightTriggeredEffect extends com.ankamagames.dofus.network.types.game.actions.fight.AbstractFightDispellableEffect {
    ...
    public FightTriggeredEffect() { }
        ...
        public FightTriggeredEffect(int uid, int targetId, short turnDuration, byte dispelable, short spellId, int effectId, int parentBoostUid, int param1, int param2, int param3, short delay) {
