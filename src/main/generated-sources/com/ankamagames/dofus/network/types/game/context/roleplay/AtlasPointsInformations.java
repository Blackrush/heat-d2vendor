...
public class AtlasPointsInformations extends NetworkType {
    ...
    public AtlasPointsInformations() { }
        ...
        public AtlasPointsInformations(byte type, com.ankamagames.dofus.network.types.game.context.MapCoordinatesExtended[] coords) {
        ...
        public AtlasPointsInformations(byte type, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.MapCoordinatesExtended> coords) {
                ...
                this.coords = coords.toArray(com.ankamagames.dofus.network.types.game.context.MapCoordinatesExtended[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int coords_length = reader.read_ui16();
                    ...
                    this.coords = new com.ankamagames.dofus.network.types.game.context.MapCoordinatesExtended[coords_length];
