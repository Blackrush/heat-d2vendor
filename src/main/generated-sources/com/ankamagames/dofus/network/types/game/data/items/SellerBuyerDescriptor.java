...
public class SellerBuyerDescriptor extends NetworkType {
    ...
    public SellerBuyerDescriptor() { }
        ...
        public SellerBuyerDescriptor(int[] quantities, int[] types, float taxPercentage, float taxModificationPercentage, short maxItemLevel, int maxItemPerAccount, int npcContextualId, short unsoldDelay) {
