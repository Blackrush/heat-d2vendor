...
public class JobCrafterDirectoryEntryPlayerInfo extends NetworkType {
    ...
    public JobCrafterDirectoryEntryPlayerInfo() { }
        ...
        public JobCrafterDirectoryEntryPlayerInfo(int playerId, java.lang.String playerName, byte alignmentSide, byte breed, boolean sex, boolean isInWorkshop, short worldX, short worldY, int mapId, short subAreaId, com.ankamagames.dofus.network.types.game.character.status.PlayerStatus status) {
