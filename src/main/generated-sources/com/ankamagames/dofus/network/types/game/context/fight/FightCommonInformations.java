...
public class FightCommonInformations extends NetworkType {
    ...
    public FightCommonInformations() { }
        ...
        public FightCommonInformations(int fightId, byte fightType, com.ankamagames.dofus.network.types.game.context.fight.FightTeamInformations[] fightTeams, short[] fightTeamsPositions, com.ankamagames.dofus.network.types.game.context.fight.FightOptionsInformations[] fightTeamsOptions) {
        ...
        public FightCommonInformations(int fightId, byte fightType, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.fight.FightTeamInformations> fightTeams, short[] fightTeamsPositions, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.fight.FightOptionsInformations> fightTeamsOptions) {
                ...
                this.fightTeams = fightTeams.toArray(com.ankamagames.dofus.network.types.game.context.fight.FightTeamInformations[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int fightTeams_length = reader.read_ui16();
                    ...
                    this.fightTeams = new com.ankamagames.dofus.network.types.game.context.fight.FightTeamInformations[fightTeams_length];

                    for (int i = 0; i < fightTeams_length; i++) {
                        
                            int fightTeams_it_typeId = reader.read_ui16();
                            com.ankamagames.dofus.network.types.game.context.fight.FightTeamInformations fightTeams_it = (com.ankamagames.dofus.network.types.game.context.fight.FightTeamInformations)
