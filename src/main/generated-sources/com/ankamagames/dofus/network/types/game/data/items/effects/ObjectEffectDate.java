...
public class ObjectEffectDate extends com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect {
    ...
    public ObjectEffectDate() { }
        ...
        public ObjectEffectDate(short actionId, short year, byte month, byte day, byte hour, byte minute) {
