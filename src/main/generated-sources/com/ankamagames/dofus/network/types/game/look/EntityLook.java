...
public class EntityLook extends NetworkType {
    ...
    public EntityLook() { }
        ...
        public EntityLook(short bonesId, short[] skins, int[] indexedColors, short[] scales, com.ankamagames.dofus.network.types.game.look.SubEntity[] subentities) {
        ...
        public EntityLook(short bonesId, short[] skins, int[] indexedColors, short[] scales, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.look.SubEntity> subentities) {
                ...
                this.subentities = subentities.toArray(com.ankamagames.dofus.network.types.game.look.SubEntity[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int subentities_length = reader.read_ui16();
                    ...
                    this.subentities = new com.ankamagames.dofus.network.types.game.look.SubEntity[subentities_length];
