...
public class JobCrafterDirectoryListEntry extends NetworkType {
    public static final int PROTOCOL_ID = 196;
        ...
        public com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo jobInfo;
    

    public JobCrafterDirectoryListEntry() { }

    
        public JobCrafterDirectoryListEntry(com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryPlayerInfo playerInfo, com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo jobInfo) {
