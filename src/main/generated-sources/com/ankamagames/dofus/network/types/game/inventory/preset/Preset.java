...
public class Preset extends NetworkType {
    ...
    public Preset() { }
        ...
        public Preset(byte presetId, byte symbolId, boolean mount, com.ankamagames.dofus.network.types.game.inventory.preset.PresetItem[] objects) {
        ...
        public Preset(byte presetId, byte symbolId, boolean mount, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.inventory.preset.PresetItem> objects) {
                ...
                this.objects = objects.toArray(com.ankamagames.dofus.network.types.game.inventory.preset.PresetItem[]::new);
    ...
    public void deserialize(DataReader reader) {
                ...
                int objects_length = reader.read_ui16();
                    ...
                    this.objects = new com.ankamagames.dofus.network.types.game.inventory.preset.PresetItem[objects_length];
