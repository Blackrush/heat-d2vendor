...
public class GameFightResumeSlaveInfo extends NetworkType {
    ...
    public GameFightResumeSlaveInfo() { }
        ...
        public GameFightResumeSlaveInfo(int slaveId, com.ankamagames.dofus.network.types.game.context.fight.GameFightSpellCooldown[] spellCooldowns, byte summonCount, byte bombCount) {
        ...
        public GameFightResumeSlaveInfo(int slaveId, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.context.fight.GameFightSpellCooldown> spellCooldowns, byte summonCount, byte bombCount) {
