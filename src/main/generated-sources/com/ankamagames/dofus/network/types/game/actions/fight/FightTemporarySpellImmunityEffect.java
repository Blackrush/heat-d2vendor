...
public class FightTemporarySpellImmunityEffect extends com.ankamagames.dofus.network.types.game.actions.fight.AbstractFightDispellableEffect {
    ...
    public FightTemporarySpellImmunityEffect() { }
        ...
        public FightTemporarySpellImmunityEffect(int uid, int targetId, short turnDuration, byte dispelable, short spellId, int effectId, int parentBoostUid, int immuneSpellId) {
