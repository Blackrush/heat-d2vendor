...
public class FightTemporaryBoostWeaponDamagesEffect extends com.ankamagames.dofus.network.types.game.actions.fight.FightTemporaryBoostEffect {
    ...
    public FightTemporaryBoostWeaponDamagesEffect() { }
        ...
        public FightTemporaryBoostWeaponDamagesEffect(int uid, int targetId, short turnDuration, byte dispelable, short spellId, int effectId, int parentBoostUid, short delta, short weaponTypeId) {
