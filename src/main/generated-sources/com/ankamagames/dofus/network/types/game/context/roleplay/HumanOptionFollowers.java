...
public class HumanOptionFollowers extends com.ankamagames.dofus.network.types.game.context.roleplay.HumanOption {
    ...
    public HumanOptionFollowers() { }
        ...
        public HumanOptionFollowers(com.ankamagames.dofus.network.types.game.look.IndexedEntityLook[] followingCharactersLook) {
        ...
        public HumanOptionFollowers(java.util.stream.Stream<com.ankamagames.dofus.network.types.game.look.IndexedEntityLook> followingCharactersLook) {
            ...
            super();
                ...
                this.followingCharactersLook = followingCharactersLook.toArray(com.ankamagames.dofus.network.types.game.look.IndexedEntityLook[]::new);
    ...
    public void deserialize(DataReader reader) {
        ...
        super.deserialize(reader);
                ...
                int followingCharactersLook_length = reader.read_ui16();
                    ...
                    this.followingCharactersLook = new com.ankamagames.dofus.network.types.game.look.IndexedEntityLook[followingCharactersLook_length];
