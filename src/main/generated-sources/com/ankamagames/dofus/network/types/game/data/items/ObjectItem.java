...
public class ObjectItem extends com.ankamagames.dofus.network.types.game.data.items.Item {
    ...
    public ObjectItem() { }
        ...
        public ObjectItem(short position, short objectGID, com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect[] effects, int objectUID, int quantity) {
        ...
        public ObjectItem(short position, short objectGID, java.util.stream.Stream<com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffect> effects, int objectUID, int quantity) {
